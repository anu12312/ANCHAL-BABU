...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
    ...
    if (args[0] == "list" || args[0] == "l") {
        ...
        api.sendMessage("[ ERR ] The ID you entered is not valid", threadID, messageID);
    } else if (data.includes(idBox)) {
        api.sendMessage(`[ - ] ID ${idBox} pre-approved!`, threadID, messageID);
    } else {
        api.sendMessage("[ OK ] ✨ApKa Group Approved Kar Diya Hai🙌.\n 🖤So Enjoy\n\n 💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝐀𝐍𝐂𝐇𝐀𝐋☜ 💫\n 🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚎𝚛 〠𝐀𝐍𝐂𝐇𝐀𝐋🖤\n😳𝐇𝐞𝐫 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐈𝐃🤓:- ☞ https://www.facebook.com/Anu.Anchal\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @DEVILL22072000😇", idBox, (error, info) => {
