...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Notice from Owner 𝐒𝐔𝐒𝐇𝐈𝐋 𝐘𝐀𝐃𝐀𝐕 «\n\n${c}, You are stupid for cursing bots so bots automatically banned you from the system`
	};
    //Add curse words without capital letters
	["bot bsdk", "mc bot", "chutiya bot", "bsdk bot", "teri maa ki chut", "jhatu bot", "rhaine bobo", "stupid bots", "kutty bot", "lund bot", "sushil mc", "mc sushil", "bsdk sushil", "fuck bots", "sushil chutiya", "sushil gandu", "bobo Ginoong choru bot", "sushil bc", "crazy bots", "bc sushil", "nikal bsdk bot", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
